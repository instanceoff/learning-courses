...
const Main = () => {
  ...
  useEffect(() => {
    setIsValid(regular.test(login) && password.length > 7);
  }, [login, password]);
  ...
  return (
    <>
      <div className="flex justify-center p-1 w-full bg-slate-700">
        <p className="text-white my-auto">
          Test account: login =={' '}
          <span className="text-blue-300">test@gmail.com</span>, password =={' '}
          <span className="text-blue-300">testtest</span>
        </p>
      </div>
